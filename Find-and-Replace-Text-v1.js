...
'<div style="padding-top:3px;"><input type="text" id="find_this_regex" value="" style="width:100%; margin-top:0px; margin-bottom:0px;" /></div>'+
...
'<div style="padding-top:3px;"><textarea id="find_this" style="width:100%;" rows="4" wrap="off"></textarea></div>';}
resizepage();}

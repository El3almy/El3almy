...
'<div style="padding-top:3px;"><input type="text" id="find_this_1_regex" value="" style="width:100%; margin-top:0px; margin-bottom:0px;" /></div>'+
'<div style="padding:7px 10px 10px 10px; margin-top:6px; line-height:1.2; background-color:#FFFFCC; border-radius:12px;">'+
...
'Remember to escape special characters .*+?^=!:${}()|\\ with a backslash when used as literals within a regular expression. Use the <a target="_blank" href="http://textmechanic.com/Escape-Literal-Characters.html" style="color:#0000FF;">Escape Literal Characters</a> tool. '+
...
'<div style="padding-top:3px;"><textarea id="find_this_1" style="width:100%;" rows="4" wrap="off"></textarea></div>';}
resizepage();}
...
function replacetext(){
var searchfor = '';
var replacewith = document.getElementById('replacetext_2').value.replace(/\r/gi,'');
var text = document.getElementById('input_output').value.replace(/\r/gi,'')
var flagg = 'g';
var flagi = 'i';
var flagm = '';
...
if(document.getElementById('multi_line').checked == true) flagm = 'm';
var flags = flagg + flagi + flagm;
if(enableregex == 'yes') searchfor = document.getElementById('find_this_1_regex').value; else searchfor = document.getElementById('find_this_2').value.replace(/\r/gi,'').replace(/([.*+?^=!:${}()|\[\]\/\\])/g,'\\$1');
var killfun = 'no';
try{var searchexp = new RegExp(searchfor,flags);}
catch(err){
alert('Something is incorrect (' + err + ') within your regular expression.\nBe sure special characters .*+?^=!:${}()|\\ used as literals have been escaped with a backslash.');
...
function replacetext(){
var searchfor = '';
var replacewith = document.getElementById('replacetext_3').value.replace(/\r/gi,'');
var text = document.getElementById('input_output').value.replace(/\r/gi,'')
var flagg = 'g';
var flagi = 'i';
var flagm = '';
...
if(document.getElementById('multi_line').checked == true) flagm = 'm';
var flags = flagg + flagi + flagm;
if(enableregex == 'yes') searchfor = document.getElementById('find_this_1_regex').value; else searchfor = document.getElementById('find_this_3').value.replace(/\r/gi,'').replace(/([.*+?^=!:${}()|\[\]\/\\])/g,'\\$1');
var killfun = 'no';
try{var searchexp = new RegExp(searchfor,flags);}
catch(err){
alert('Something is incorrect (' + err + ') within your regular expression.\nBe sure special characters .*+?^=!:${}()|\\ used as literals have been escaped with a backslash.');
